package de.hska.iwi.microservice.gateway.security;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  private static final String OAUTH_ROUTE = "/api/uaa/**";
  private static final String LOGIN_ROUTE = "/api/login";
  private static final String AUTHENTICATION_REGISTRATION_ROUTE = "/api/auth/registration/**";
  ...
  public void configure(HttpSecurity http) throws Exception {
    http.authorizeRequests()
        .antMatchers(OAUTH_ROUTE, LOGIN_ROUTE, "/routes", AUTHENTICATION_REGISTRATION_ROUTE)
        .permitAll()
  ...
  private RequestMatcher csrfRequestMatcher() {
    return new RequestMatcher() {
      ...
      private final AntPathRequestMatcher[] requestMatchers = {
          new AntPathRequestMatcher(OAUTH_ROUTE),
          new AntPathRequestMatcher("/routes"),
          new AntPathRequestMatcher(AUTHENTICATION_REGISTRATION_ROUTE)
      };
