...
package de.hska.iwi.microservice.category.config;

import de.hska.iwi.microservice.category.CategoryServer;
...
public class CategoryServerConfig {
    private static final String DB_CONFIG_FILE = "db-config.properties";
    private final Logger logger = Logger.getLogger(CategoryServerConfig.class);

    public CategoryServerConfig() {
        super();
        logger.info("Kategorie-Konfiguration wurde geladen.");
    }
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            input = CategoryServer.class.getClassLoader().getResourceAsStream(DB_CONFIG_FILE);
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource){
        ...
        try{
            ...
            factory.setPackagesToScan(CategoryRepository.class.getPackage().getName());
