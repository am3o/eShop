...
public class CatalogServiceFacade implements ICatalogServiceFacade {
  ...
  public boolean checkPermission(Credential credential) {
    ...
    authenticationServiceClient = (AuthenticationServiceClient) setUpClientService(discoveryClient,
        AUTHENTICATION_SERVICE);
    return authenticationServiceClient
        .existCustomer(credential.getUsername(), credential.getPassword(), true);
  }
  ...
  public List<Category> getAllCategories() {
    categoryServiceClient = (CategoryServiceClient) setUpClientService(discoveryClient,
        CATEGORY_SERVICE);
    logger.info(categoryServiceClient.getClass().toString());
  ...
  public Product createProduct(Product product) {
    productServiceClient = (ProductServiceClient) setUpClientService(discoveryClient,
        PRODUCT_SERVICE);
